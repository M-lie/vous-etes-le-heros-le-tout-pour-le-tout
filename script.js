let chapter1 = {
    ...
    options: tab1 = [{text: "Commencer", action: goToChapter(chapter2)}]
};
...
let chapter2 = {
    ...
    options: tab2 = [{text: "S'accroupir", action: goToChapter(chapter3)}, {text: "Courir", action: goToChapter(chapter4)}]
};
...
let chapter3 = {
    ...
    options: tab3 = [{text: "Continuer", action: goToChapter(chapter5)}]
};
...
let chapter4 = {
    ...
    options: tab4 = [{text: "Recommencer", action: goToChapter(chapter1)}]
};
...
let chapter5 = {
    ...
    options: tab5 = [{text: "Patienter", action: goToChapter(chapter6)}, {text: "Fouiller le bureau", action: goToChapter(chapter7)}, {text: "Appeler les secours", action: goToChapter(chapter8)}]
};
...
let chapter7 = {
    ...
    options: tab6 = [{text: "Continuer", action: goToChapter(chapter9)}]
};
...
let chapter9 = {
    ...
    options: tab7 = [{text: "Rester dans le bureau", action: goToChapter(chapter10)}, {text: "Aller à l'intérieur", action: goToChapter(chapter11)}]
};
...
let chapter11 = {
    ...
    options: tab8 = [{text: "Continuer", action: goToChapter(chapter12)}]
};
...
let chapter12 = {
    ...
    options: tab9 = [{text: "Lui donner les clés", action: goToChapter(chapter13)}, {text: "Lui proposer un marché", action: goToChapter(chapter14)}, {text: "Lui mentir", action: goToChapter(chapter15)}]
};
...
let chapter14 = {
    ...
    options: tab10 = [{text: "Continuer", action: goToChapter(chapter16)}]
};
...
let chapter16 = {
    ...
    options: tab11 = [{text: "Oui", action: goToChapter(chapter17)}, {text: "Non", action: goToChapter(chapter18)}]
};
